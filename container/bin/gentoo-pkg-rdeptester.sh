...
### Usage: gentoo-pkg-rdeptester.sh category/package
### Example: gentoo-pkg-rdeptester.sh dev-libs/efl
###
...
### 
### Example: gentoo-pkg-rdeptester.sh -a dev-cpp/glibmm
### 
...
###
### Uses pkg-testing-tool, https://github.com/APN-Pucky/pkg-testing-tools
### 
